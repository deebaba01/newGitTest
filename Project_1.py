...
#### Create Purchasing Information and Receipts for Lovely Loveseats Create Purchasing Information and Receipts for Lovely Loveseats

#•••••#Project PYTHON FUNCTIONS AND LOGIC
...
# We used our knowledge of strings and numbers to create and update variables.
